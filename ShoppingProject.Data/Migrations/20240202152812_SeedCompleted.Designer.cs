...
namespace ShoppingProject.Data.Migrations
{
    ...
    [Migration("20240202152812_SeedCompleted")]
            ...
            modelBuilder.Entity("ShoppingProject.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 2, 18, 28, 11, 843, DateTimeKind.Local).AddTicks(4304),
                            IsDeleted = false,
                            Name = "Kazak"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 2, 2, 18, 28, 11, 843, DateTimeKind.Local).AddTicks(4309),
                            IsDeleted = false,
                            Name = "T-Shirt"
                        });
                });
            ...
            modelBuilder.Entity("ShoppingProject.Entity.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("154339ef-14b2-4c67-8706-525d8988c500"),
                            CategoryId = new Guid("9a99ad62-b618-4dca-a254-5843255ab008"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 2, 2, 18, 28, 11, 843, DateTimeKind.Local).AddTicks(4465),
                        ...
                        new
                        {
                            Id = new Guid("eac6e9f8-f8ab-496a-a613-4e7fc675ad8a"),
                            CategoryId = new Guid("9ec7d5a6-ee4a-4f21-885a-21a89e95559d"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 2, 2, 18, 28, 11, 843, DateTimeKind.Local).AddTicks(4470),
                            Description = "Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.",
                            IsDeleted = false,
